#!/usr/bin/env python3
"""
Working script to modify exam questions to show 3 options instead of 4
"""
...
class Exam3OptionsProcessor:
    ...
    def select_3_options(self, question: Dict[str, Any]) -> Tuple[List[str], str]:
        ...
        try:
            ...
            # Fallback: return first 3 options
            options = [question.get(f'answer{i}', '') for i in range(1, 5)]
            valid_options = [opt for opt in options if opt and opt.strip()]
            return valid_options[:3], 'A'
...
def main():
    ...
    print("🎯 Working 3-Options Exam Processor")
    print("=" * 50)
