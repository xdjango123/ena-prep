#!/usr/bin/env python3
"""
AI-powered question generator for examen blanc questions - FIXED VERSION
...
class ExamenBlancQuestionGenerator:
    ...
    def get_existing_questions(self, category: str, limit: int = 3) -> List[Dict[str, Any]]:
    ...
    def generate_questions(self, category: str, difficulty: str, count: int) -> List[Dict[str, Any]]:
        ...
        examples = self.get_existing_questions(category, 2)
    ...
    def generate_all_questions(self):
        ...
        for category in categories:
            ...
            for difficulty in difficulties:
                ...
                # Generate in batches of 3 to avoid token limits and ensure quality
                batch_size = 3
