...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = clsx(
    ...
    {
      'w-full': fullWidth,
      'px-2 py-1.5 text-xs xs:px-3 xs:py-1.5 xs:text-sm min-h-[36px]': size === 'sm',
      'px-3 py-2 text-sm xs:px-4 xs:py-2 xs:text-base min-h-[40px]': size === 'md',
      'px-4 py-2.5 text-base xs:px-6 xs:py-3 xs:text-lg min-h-[44px]': size === 'lg',
